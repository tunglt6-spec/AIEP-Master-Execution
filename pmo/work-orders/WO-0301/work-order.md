...
# WO-0301 — Installer & Packaging

## Objective

Provide install scripts and `aiep package` release tarball preparation.
...
Packaging affects distribution; dual local review verifies gate enforcement.

## Traceability

- Governance: docs/governance/REVIEW-LEVEL-POLICY.md
- Scope: docs/governance/SCOPE-LOCK-v1.0.md
- Artifacts: .aiep/artifacts/WO-0301/
